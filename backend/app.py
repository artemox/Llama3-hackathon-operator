...
def generate_answer():
    ...
    #     return generate_claude_answer(prompt, model)
    # # elif "cohere" in model.lower() and "oci" in model.lower():
    # #     return generate_oci_cohere_answer(prompt, model)
    # elif "octo" in model.lower():
    #     return generate_octo_llama_answer(prompt, model)
    # elif "cohere" in model.lower():
    #     return generate_cohere_answer(prompt, model)
    # elif "gpt" in model.lower():
    #     return generate_gpt_answer(prompt, model)
    # else:
    #     return generate_gpt_answer(prompt, "gpt-3.5-turbo")
    print(answer)
